...
// EYToolkit
#define COCOAPODS_POD_AVAILABLE_EYToolkit
#define COCOAPODS_VERSION_MAJOR_EYToolkit 1
#define COCOAPODS_VERSION_MINOR_EYToolkit 0
#define COCOAPODS_VERSION_PATCH_EYToolkit 0
